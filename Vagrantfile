...
Vagrant.configure(2) do |config|
  ...
  #config.vm.synced_folder '$HOME/controller/ansible/', '/vagrant/controller/ansible/'
  config.vm.provision "file", source: "~/controller/ansible/", destination: "/vagrant/ansible"
